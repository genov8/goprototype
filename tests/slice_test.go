...
func TestAppend(t *testing.T) {
	sliceProto := prototype.NewSlicePrototype([]interface{}{1, 2, 3})
...
func TestPrintSlice(t *testing.T) {
	sliceProto := prototype.NewSlicePrototype([]interface{}{1, 2, 3, 4, 5})
...
func TestUnique(t *testing.T) {
	sliceProto := prototype.NewSlicePrototype([]interface{}{1, 2, 2, 3, 4, 4, 5})
...
func TestFlatten(t *testing.T) {
	nestedSlice := prototype.NewSlicePrototype([]interface{}{
		[]interface{}{1, 2},
	...
	flatSlice := prototype.NewSlicePrototype([]interface{}{1, 2, 3})
	...
	nonSlice := prototype.NewSlicePrototype(123)
...
func TestMap(t *testing.T) {
	slicePrototype := prototype.NewSlicePrototype([]interface{}{1, 2, 3, 4})
	...
	slicePrototype = prototype.NewSlicePrototype([]interface{}{"a", "b", "c"})
	result, err = slicePrototype.Map(func(val interface{}) interface{} {
	...
	intPrototype := prototype.NewSlicePrototype(123)
...
func TestFilter(t *testing.T) {
	slicePrototype := prototype.NewSlicePrototype([]interface{}{1, 2, 3, 4, 5})
	...
	slicePrototype = prototype.NewSlicePrototype([]interface{}{"apple", "banana", "cherry"})
	result, err = slicePrototype.Filter(func(val interface{}) bool {
		if str, ok := val.(string); ok {
			return len(str) > 5
		}
...
func TestChunk(t *testing.T) {
	slice := prototype.NewSlicePrototype([]interface{}{1, 2, 3, 4, 5, 6})
	...
	slice = prototype.NewSlicePrototype([]interface{}{1, 2, 3, 4, 5})
	result, err = slice.Chunk(2)
	if err != nil {
		t.Errorf("Expected no error, got %v", err)
	}
	...
	notSlice := prototype.NewSlicePrototype(123)
...
func TestIntersect(t *testing.T) {
	slice1 := prototype.NewSlicePrototype([]interface{}{1, 2, 3, 4})
	slice2 := prototype.NewSlicePrototype([]interface{}{3, 4, 5, 6})
	...
	slice1 = prototype.NewSlicePrototype([]interface{}{1, 2})
	slice2 = prototype.NewSlicePrototype([]interface{}{3, 4})
	result, err = slice1.Intersect(slice2)
	if err != nil {
		t.Errorf("Expected no error, got %v", err)
	}
	...
	notSlice := prototype.NewSlicePrototype(42)
...
func TestZip(t *testing.T) {
	slice1 := prototype.NewSlicePrototype([]interface{}{1, 2, 3})
	slice2 := prototype.NewSlicePrototype([]interface{}{"a", "b", "c"})
...
func TestSort(t *testing.T) {
	slice := prototype.NewSlicePrototype([]interface{}{5, 3, 8, 1})
	...
	slice = prototype.NewSlicePrototype([]interface{}{"banana", "apple", "cherry"})
	result, err = slice.Sort(nil)
	if err != nil {
		t.Errorf("Expected no error, got %v", err)
	}
	...
	slice = prototype.NewSlicePrototype([]interface{}{5, "string"})
...
func TestRotate(t *testing.T) {
	...
	slice = prototype.NewSlicePrototype([]interface{}{})
